...
# 분기점 (node)
# 잎노드(leaf node) : 최종적으로 잦게 되는 노드 
# 가장 많은(가장 빈도수가 높은 클래스를 예측잢으로 분류 , -> 많은 잎노드를 갖는 것을 선택 
# 깊이 : max_depth 
...
# ### 배깅 (랜덤포레스트)
# 같은 종류의 알고리즘 모델을 여러 개 결합 

# In[38]:


#Decision Tree 의 한 한 항목이다. 
#모델을 여러개 사용 
